...
* [Start the VISS client](https://github.com/eclipse-kuksa/kuksa-databrokerblob/master/kuksa_viss_client/README.md) and perform some basic tests that VSS changes are present
...
The [VISS client](https://github.com/eclipse-kuksa/kuksa-databrokerblob/master/kuksa_viss_client/README.md) can be used to verify that data actually is correctly interpreted.
