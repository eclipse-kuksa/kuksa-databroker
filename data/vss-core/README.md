...
* [Start Kuksa Client](https://github.com/eclipse-kuksa/kuksa-databrokerblob/master/kuksa-client/README.md) and perform some basic tests that VSS changes are present
...
The [Kuksa Client](https://github.com/eclipse-kuksa/kuksa-databrokerblob/master/kuksa-client/README.md) can be used to verify that data actually is correctly interpreted.
