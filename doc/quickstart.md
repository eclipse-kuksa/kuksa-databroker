...
```
docker run -it --rm --net=host ghcr.io/eclipse-kuksa/kuksa-databrokerkuksa-client:master
```
...
```
docker run -it --rm --net=host ghcr.io/eclipse-kuksa/kuksa-databrokerkuksa-client:master grpc://127.0.0.1:55556
```
